...
export type WebhookPayload =
    | { event: "purchase.requested"; delivery_id: string; created_at: string; data: PurchaseRequestedData }
    | { event: "purchase.refunded"; delivery_id: string; created_at: string; data: PurchaseRefundedData }
    | { event: "ticket.expired"; delivery_id: string; created_at: string; data: TicketExpiredData };
